...
import (
	...
	"pulley.com/shakesearch/restapi/operations"
	"pulley.com/shakesearch/restapi/operations/public"
	"pulley.com/shakesearch/restapi/operations/system"
)

//go:generate swagger generate server --target ../../shakesearch --name TerseURL --spec ../swagger.yml --principal interface{}
...
func configureAPI(api *operations.TerseURLAPI) http.Handler {
	...
	if api.PublicShakeSearchHandler == nil {
		api.PublicShakeSearchHandler = public.ShakeSearchHandlerFunc(func(params public.ShakeSearchParams) middleware.Responder {
