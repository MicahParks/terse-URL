...
func (o *TerseRedirectURL) Build() (*url.URL, error) {
	...
	if shortened != "" {
		...
		return nil, errors.New("shortened is required on TerseRedirectURL")
	}
...
func (o *TerseRedirectURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on TerseRedirectURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on TerseRedirectURL")
	}
