...
// TerseExportOneParams contains all the bound params for the terse export one operation
...
func (o *TerseExportOneParams) bindShortened(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
