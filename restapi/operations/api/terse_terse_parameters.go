...
// TerseTerseParams contains all the bound params for the terse terse operation
...
func (o *TerseTerseParams) bindShortened(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
